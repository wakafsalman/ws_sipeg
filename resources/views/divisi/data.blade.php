...
<div class="content-wrapper">
  ...
  <section class="content-header">  
    <div class="row">
      <div class="col-md-1">
        <a href="/tambah_divisi" class="btn btn-success mb-4"><i class="glyphicon glyphicon-plus"></i> Tambah Divisi</a>
      </div>
    </div>
  </section>
      ...
      <div class="box-body">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tr>
            ...
            <td>{{ $row->nama }}</td>
            <td>
                <a href="/rubah_divisi/{{ $row->id }}" class="btn btn-info"><i class="glyphicon glyphicon-pencil"></i> Edit</a>
