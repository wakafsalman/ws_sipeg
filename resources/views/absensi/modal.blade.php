...
<div class="modal fade" id="modal-absen">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" action="/presensi" method="POST" enctype="multipart/form-data" id="validasi_absensi">
            @csrf
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal" class="form-control" id="exampleInputBirthdate">
                        <span class="text-danger error-text tanggal_error"></span>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputCheckIn" class="form-label">Jam Absen Masuk</label>
                        <input type="time" name="jam_masuk" class="form-control" id="exampleInputCheckIn">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="hasil_kerja[]" class="form-control" id="exampleInputResultWork" multiple="true">
                        ...
                        <span class="text-danger error-text hasil_kerja_error"></span>
                    </div>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <table id="example1" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><span class="text-danger error-text demam_error"></span></td>
                                </tr>                                
                                <tr>
                                ...
                                <tr>
                                    <td><span class="text-danger error-text batuk_dahak_error"></span></td>
                                </tr>                                
                                <tr>
                                ...
                                <tr>
                                    <td><span class="text-danger error-text batuk_kering_error"></span></td>
                                </tr>                                
                                <tr>
                                ...
                                <tr>
                                    <td><span class="text-danger error-text lelah_error"></span></td>
                                </tr>                                
                                <tr>
                                ...
                                <tr>
                                    <td><span class="text-danger error-text sesak_nafas_error"></span></td>
                                </tr>                                
                                <tr>
                                ...
                                <tr>
                                    <td><span class="text-danger error-text nyeri_sendi_error"></span></td>
                                </tr>                                
                                <tr>
                                ...
                                <tr>
                                    <td><span class="text-danger error-text sakit_kepala_error"></span></td>
                                </tr>                                
                                <tr>
                                ...
                                <tr>
                                    <td><span class="text-danger error-text bersin_error"></span></td>
                                </tr>                                
                                <tr>
                                ...
                                <tr>
                                    <td><span class="text-danger error-text pilek_error"></span></td>
                                </tr>                                
                                <tr>
                                ...
                                <tr>
                                    <td><span class="text-danger error-text hidung_mampet_error"></span></td>
                                </tr>                                                                
                                <tr>
                                ...
                                <tr>
                                    <td><span class="text-danger error-text mata_berair_error"></span></td>
                                </tr>                                
                                <tr>
                                ...
                                <tr>
                                    <td><span class="text-danger error-text sakit_tenggorokan_error"></span></td>
                                </tr>                                
                                <tr>
                                ...
                                <tr>
                                    <td><span class="text-danger error-text diare_error"></span></td>
                                </tr>                                
                            </tbody>
                          </table>
                    </div>
                    <div class="form-group">
                        ...
                        <span class="text-danger error-text cium_aroma_error"></span>
                    </div>
                    <div class="form-group">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="time" name="jam_keluar" class="form-control" id="exampleInputCheckIn">
